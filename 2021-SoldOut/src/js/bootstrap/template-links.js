export const templateLinks = () => {
  const ul = document.querySelector('.custom-links-template article.ha__main-article-content ul')
  if (ul !== null) ul.classList.add('row', 'mx-0')
  document.querySelectorAll('.custom-links-template ul li').forEach(block => {
